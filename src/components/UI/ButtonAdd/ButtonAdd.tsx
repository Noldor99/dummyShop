...
import { addItemAction } from '../../../store/redusers/cartSlice';

interface ButtonAddProps {
  product: IProduct
}

const ButtonAdd: FC<ButtonAddProps> = ({ product }: ButtonAddProps) => {
  ...
  const cartItem = useTypedSelector((state: RootState) =>
